...
import CartModal from "@/src/modules/layout/store/components/CartModal";
    ...
    <>
      <header className="sticky top-0 z-40 w-full bg-white/80 backdrop-blur-md border-b border-zinc-200">
        <div className="max-w-7xl mx-auto px-6 md:px-8 h-16 md:h-16 flex items-center justify-between gap-4">
          ...
          <div className="hidden md:flex items-center gap-2 bg-zinc-100/80 border border-zinc-200 rounded-full px-2  min-h-10 shadow-xs">
            {isMounted && user ? (
              <>
