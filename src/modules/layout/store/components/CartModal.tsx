                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-col gap-1.5 mt-2">
                      <div className="flex items-center gap-3">
                        <div
                          className={`flex items-center rounded-full p-1 gap-1 transition-colors ${item.quantity >= item.stock ? "bg-orange-50 border border-orange-200/60" : "bg-zinc-100 border border-zinc-200/40"}`}
                        >
                          <button
                            type="button"
                            onClick={() =>
                          ...
                          <span
                            className={`text-xs font-bold w-6 text-center select-none ${item.quantity >= item.stock ? "text-orange-600" : "text-zinc-800"}`}
                          >
                            {item.quantity}
                          </span>
                          <button
                            ...
                            className="w-7 h-7 flex items-center justify-center text-zinc-500 hover:text-zinc-900 hover:bg-white active:scale-90 rounded-full transition-all cursor-pointer disabled:opacity-25 disabled:pointer-events-none"
