...
export default function AdminHeader({ title = "Огляд" }: AdminHeaderProps) {
  ...
  return (
    <header className="border-b border-zinc-800/40 bg-[#0b0c10] sticky top-0 z-40 flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-6 py-3 sm:py-0 sm:h-16">
      ...
      <div className="flex items-center gap-2.5 text-zinc-400 text-xs font-semibold bg-zinc-900/40 px-3.5 py-2 rounded-xl border border-zinc-800/40 shadow-xs w-fit">
